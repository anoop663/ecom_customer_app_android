            ...
            children: [
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    // Displaying the product image with a fallback to an asset image
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          placeholder: 'assets/images/no_image.png', // Fallback asset image
                          image: '${ApiConfig.productImageUrl}${product.image}',
                          fit: BoxFit.cover,
                          imageErrorBuilder: (context, error, stackTrace) {
                            return Image.asset(
                              'assets/images/no_image.png', // Show asset if image loading fails
                              fit: BoxFit.cover,
                            );
                          },
                        ),
              ...
              Row(
                ...
                children: [
                  Obx(() => CurvedButton(
                        onClick: () => controller.removeItem(product),
                        width: MediaQuery.of(context).size.width * 0.3,
                  ...
                  Obx(() => CurvedButton(
                        onClick: () => controller.moveToWishList(product),
